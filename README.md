# `mvndst_jll.jl` (v1.0.0+0)

[![deps](https://juliahub.com/docs/mvndst_jll/deps.svg)](https://juliahub.com/ui/Packages/mvndst_jll/RWDQ0?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/7ea31f41f54f040002311fd9f04fe641f975ddc5/M/mvndst/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `mvndst_jll.jl` have been built from these sources:

* file: https://raw.githubusercontent.com/scipy/scipy/main/scipy/stats/mvndst.f (SHA256 checksum: `51758c4f37153dd0d9eab2e002c0ec98c944551e05d5fed0e1900a711a0de1e0`)
* file: https://raw.githubusercontent.com/scipy/scipy/main/LICENSE.txt (SHA256 checksum: `86627b745e4937371bd5d3061a76b07501c0dd01e5c0ce2b2a9c25c9c1944f18`)

## Platforms

`mvndst_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `mvndst_jll.jl`:
